...
export function buildAfterPlaceholder(
  ...
  return {
    ...
    review_mode_label: "Quick read",
    review_mode_explainer: "Quick read uses the visible answer and lighter signals to guide the next move.",
    ...
    decision_display_label: "Not clear yet",
    delta_from_quick: "",
